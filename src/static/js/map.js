...
window.BMAP_AUTHENTIC_KEY = ""; (function() {
    ...
    z.lang.Ga.prototype.addEventListener = function(a, b, c) {
        if (z.lang.Ks(b)) { ! b.Uk && (b.Uk = {}); ! this.wi && (this.wi = {});
            var e = this.wi,
            f;
    ...
    z.lang.Ga.prototype.removeEventListener = function(a, b) {
        ...
        if (z.lang.Ks(b)) {
            ...
            b = b.Uk[a].Ww
        } else if (!z.lang.sg(b)) return; ! this.wi && (this.wi = {});
        var c = this.wi;
        c[a] && c[a][b] && delete c[a][b]
    };
    z.lang.Ga.prototype.dispatchEvent = function(a, b) {
        z.lang.sg(a) && (a = new z.lang.cu(a)); ! this.wi && (this.wi = {});
        var b = b || {},
        c;
        for (c in b) a[c] = b[c];
        var e = this.wi,
    ...
    z.aK = function() {
        function a(a) {
            document.addEventListener && (this.element = a, this.dK = this.sk ? "touchstart": "mousedown", this.BC = this.sk ? "touchmove": "mousemove", this.AC = this.sk ? "touchend": "mouseup", this.hh = t, this.It = this.Ht = 0, this.element.addEventListener(this.dK, this, t), ja.V(this.element, "mousedown", u()), this.handleEvent(s))
        }
        a.prototype = {
            ...
            move: function(a) {
                ...
                if (10 < Math.abs((this.sk ? a.touches[0].clientX: a.clientX) - this.Ht) || 10 < Math.abs(c - this.It)) this.hh = p
            },
            end: function(a) {
                oa(a);
    ...
    z.extend(Oa.prototype, {
        ...
        Xj: function(a, b, c, e) {
            ...
            if (c = c && e ? g.ci(c, this.Wb) : this.gc) if (this.gc = new J(c.lng + a * f, c.lat - b * f), (a = g.gh(this.gc, this.Wb)) && i) this.pe = a
        },
        Cg: function(a, b) {
        ...
        ki: function(a) {
            a instanceof J && (this.gc = this.Pc.ci(a, this.Wb), this.pe = J.oL(a) ? new J(a.lng, a.lat) : this.Pc.gh(this.gc, this.Wb))
        },
        xg: function(a, b) {
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
        ...
        KZ: function(a) {
            a === ab || a === Va ? (this.Tx(p), this.gN(t), this.R.og = t, this.R.gk = t) : (this.Tx(t), this.gN(p), this.R.og = p, this.R.gk = p)
        },
        qf: function(a) {
            var b = this;
        ...
        Hb: function() {
            return this.Or && this.Or instanceof P ? new P(this.Or.width, this.Or.height) : new P(this.Ya.clientWidth, this.Ya.clientHeight)
        },
        Ae: function(a) {
            a && a instanceof P ? (this.Or = a, this.Ya.style.width = a.width + "px", this.Ya.style.height = a.height + "px") : this.Or = s
        },
        Cb: x("pe"),
        ka: x("Va"),
        EU: function() {
        ...
        UQ: function(a, b) {
            for (var c = this.va(), e = b.margins || [10, 10, 10, 10], f = b.zoomFactor || 0, g = e[1] + e[3], e = e[0] + e[2], i = c.aj(), k = c = c.Yh(); k >= i; k--) {
                var m = this.va().fc(k);
        ...
        zs: function(a, b) {
            ...
            for (var b = b || {},
            f = [], g = 0, i = e.length; g < i; g++) f.push(this.Pc.ci(e[g], this.Wb));
            e = new hb;
            for (g = f.length - 1; 0 <= g; g--) e.extend(f[g]);
            if (e.lj()) return c;
            c = e.Cb();
            f = this.UQ(e, b);
            b.margins && (e = b.margins, g = (e[1] - e[3]) / 2, e = (e[0] - e[2]) / 2, i = this.va().fc(f), b.offset && (g = b.offset.width, e = b.offset.height), c.lng += i * g, c.lat += i * e);
        ...
        MZ: function(a) {
            ...
            window.cb = function(a) {
                if (0 === a.status) {
                    3 === a.data.style.length ? (window.bmap_baseFs || (window.bmap_baseFs = a.data.style), window.Np = a.data.style[2]) : window.Np = a.data.style;
                    a = window.bmap_baseFs;
                    if (z.om(window.rh)) window.q0 = a,
                    c.eF(e);
                    else {
                        c.WN(window.Np, e);
                        c.eF(e);
        ...
        RW: function(a, b) {
            ...
            b.styleJson ? f += "styles=" + encodeURIComponent(this.RE(b.styleJson, parseInt(a, 10))) : b.styleId && (f += "styles=" + encodeURIComponent(c.RE(c.i_, parseInt(a, 10))));
            pa(f)
        },
        zE: function(a, b) {
        ...
        ot: function(a) {
            ...
            if (a) {
                ...
                Ta(5050, c);
                a.style && (c = b.R.FB[a.style] ? b.R.FB[a.style].backColor: b.R.FB.normal.backColor) && (this.Ta().style.backgroundColor = c)
            }
        },
        HX: function(a) {
        ...
        RE: function(a, b) {
            ...
            window.La[b] = {};
            for (var g = 0,
            i; i = a[g]; g++) if (!this.XX(i) && (window.rh = this.qX(i, window.rh), this.YX(i, b))) {
                if (("land" === i.featureType || "all" === i.featureType || "background" === i.featureType) && "string" === typeof i.elementType && ("geometry" === i.elementType || "geometry.fill" === i.elementType || "all" === i.elementType) && i.stylers) if (i.stylers.color && (window.La[b].bmapLandColor = i.stylers.color, window.La[b].CL = p, window.bmapLandColor = i.stylers.color), i.stylers.visibility && "off" === i.stylers.visibility) window.La[b].bmapLandColor = "#00000000",
                window.La[b].CL = p,
                window.bmapLandColor = "#00000000";
                if ("railway" === i.featureType && "string" === typeof i.elementType && i.stylers) {
                    if (i.stylers.color && ("geometry" === i.elementType && (window.bmapRailwayFillColor = i.stylers.color, window.bmapRailwayStrokeColor = i.stylers.color, window.La[b].bmapRailwayFillColor = i.stylers.color, window.La[b].bmapRailwayStrokeColor = i.stylers.color, window.La[b].LM = p, window.La[b].MM = p), "geometry.fill" === i.elementType && (window.bmapRailwayFillColor = i.stylers.color, window.La[b].bmapRailwayFillColor = i.stylers.color, window.La[b].LM = p), "geometry.stroke" === i.elementType)) window.bmapRailwayStrokeColor = i.stylers.color,
                ...
                z.extend(k, i);
                i = [];
                for (var m in c) if (k[m] && !this.TX(m)) if ("elementType" === m) i.push(c[m] + ":" + e[k[m]]);
                else {
                    switch (k[m]) {
                    case "poilabel":
                        k[m] = "poi";
            ...
            } ! window.La[b].CL && window.La[b].bmapLandColor && delete window.La[b].bmapLandColor; ! window.La[b].LM && window.La[b].bmapRailwayFillColor && delete window.La[b].bmapRailwayFillColor; ! window.La[b].MM && window.La[b].bmapRailwayStrokeColor && delete window.La[b].bmapRailwayStrokeColor; ! window.La[b].dZ && window.La[b].bmapRailwayVisibility && delete window.La[b].bmapRailwayVisibility; ! window.La[b].nZ && window.La[b].bmapRoadarrowVisibility && delete window.La[b].bmapRoadarrowVisibility;
            return f.join(",")
        },
        j_: function(a) {
            for (var b = {
        ...
        WN: function(a, b) {
            window.Xt[b] = a;
            if (!window.rh[b]) for (var c = this.xb.aj(), e = this.xb.Yh(); c <= e; c++) window.rh[c] || (window.Xt[c] = a)
        },
        eF: function(a) {
            if (!window.rh[a]) for (var b = this.xb.aj(), c = this.xb.Yh(); b <= c; b++) window.rh[b] || (window.La[b] || (window.La[b] = {}), window.La[b].bmapLandColor = window.La[a].bmapLandColor, window.La[b].bmapRailwayFillColor = window.La[a].bmapRailwayFillColor, window.La[b].bmapRailwayStrokeColor = window.La[a].bmapRailwayStrokeColor)
        },
        xU: function(a, b) {
            var c = {};
            z.extend(c, a);
            if (c[b]) {
                for (var e = this.xb.aj(), f = this.xb.Yh(); e <= f; e++) if (!c[e]) {
                    c[e] = p;
                    break
                }
                delete c[b]
    ...
    D.Zh = function(a, b) {
        ...
        default:
            e = D.url.domain[a],
            "[object Array]" == Object.prototype.toString.call(e) ? (c = [], z.lc.Ob(e,
            function(a, e) {
                c[e] = D.url.proto + a + "/" + b
    ...
    function xb(a) {
        var b = eb();
        b >= a.jz ? ($a(a.m.za) && a.m.za(a.m.ac(1)), $a(a.m.finish) && a.m.finish(), 0 < a.Yf.length && (b = a.Yf[0], b.Yf = [].concat(a.Yf.slice(1)), b.start())) : (a.Qx = a.m.ac((b - a.mu) / a.m.duration), $a(a.m.za) && a.m.za(a.Qx), a.TE || (a.sr = setTimeout(function() {
            xb(a)
        },
        1E3 / a.m.Hc)))
    }
    ...
    function(a, b, c) {
        ...
        function(a, b, c) {
            ...
            q && (q.mh && m() < q.mh) && (c.alog("cus.on", "time",
            function(a) {
                var b = {},
                e = t,
                f;
            ...
            if (v && v.mh && m() < v.mh) {
                ...
                Ji = function() {
                    return "Promise" in a && "cast" in a.Lp && "resolve" in a.Lp && "reject" in a.Lp && "all" in a.Lp && "race" in a.Lp &&
                    function() {
                        var b;
                        new a.Lp(function(a) {
                            b = a
    ...
    z.object.extend(K, {
        ...
        tJ: function(a) {
            if (a && this.vK()[a]) for (var a = this.vK()[a], b = 0; b < a.length; b++) this.tJ(a[b]),
            this.Qd.ll[a[b]] || this.JM(a[b])
        },
        JM: function(a) {
            for (var b = 0; b < this.Qd.Zm.length; b++) if (this.Qd.Zm[b] == a) return;
            this.Qd.Zm.push(a)
        },
        oZ: function(a, b) {
            var c = this.lb(a);
        ...
        lb: function(a) {
            this.Qd.ll[a] || (this.Qd.ll[a] = {},
            this.Qd.ll[a].Ke = this.uj.HF, this.Qd.ll[a].ru = []);
            return this.Qd.ll[a]
        },
        remove: function(a) {
            delete this.lb(a)
        ...
        BU: function(a, b) {
            for (var c = this.Qd.uv,
            e = p,
            f = 0,
            g = c.length; f < g; f++)"" == c[f].ZD && (c[f].aM == a ? c[f].ZD = b: e = t);
            e && this.cK()
        },
        cK: function() {
            for (var a = this.Qd.uv,
            b = 0,
            c = a.length; b < c; b++) this.oZ(a[b].aM, a[b].ZD);
            this.Qd.uv.length = 0
        }
    });
    function R(a, b) {
    ...
    function kb(a, b) {
        a && (this.Mb = a, this.ea = "spot" + kb.ea++, b = b || {},
        this.Sg = b.text || "", this.$u = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.aB = b.userData || s, this.Dh = b.minZoom || s, this.Df = b.maxZoom || s)
    }
    kb.ea = 0;
    ...
    z.extend(Ub.prototype, {
        ...
        Fe: function(a) { ! this.P && (this.initialize && $a(this.initialize)) && (this.P = this.initialize(a));
            this.m = this.m || {
                zg: t
            };
            this.PA();
    ...
    z.object.extend($b.prototype, {
        ...
        Qv: function(a) {
            if (a && Za(a.id) && !isNaN(a.id)) {
                ...
                c;
                for (c in a) b[c] = a[c];
                if (a = this.am(a.id)) for (var e in b) a[e] = b[e];
                else this.cc.push(b)
            }
        },
        am: function(a) {
            for (var b = 0,
            c = this.cc.length; b < c; b++) if (this.cc[b].id == a) return this.cc[b]
        },
        SC: x("cc"),
        nE: function(a) {
            for (var b = 0,
            c = this.cc.length; b < c; b++) this.cc[b].id == a && (r = this.cc.splice(b, 1), b--, c = this.cc.length)
        },
        vf: function() {
            var a = this;
    ...
    z.object.extend(fc.prototype, {
        ...
        pE: function(a) {
            if (this.De[a]) {
                for (var b = 0,
                c = this.Aa.length; b < c; b++) this.Aa[b] && ("divider" == this.Aa[b].Nb && this.Aa[b].Bj == a) && (this.Aa.splice(b, 1), c--),
                this.Aa[b] && ("divider" == this.Aa[b].Nb && this.Aa[b].Bj > a) && this.Aa[b].Bj--;
                this.De.splice(a, 1)
            }
        },
        Zc: x("P"),
    ...
    function hb(a, b) {
        ...
        a && (this.Dl = new J(a.lng, a.lat), this.ol = new J(b.lng, b.lat), this.Le = a.lng, this.Yd = a.lat, this.Ge = b.lng, this.Wd = b.lat)
    }
    ...
    z.extend(S, {
        ...
        dc: function(a) {
            ...
            for (var e = 0; e < this.LF.length; e++) if (b.lat >= this.LF[e]) {
                c = this.FO[e];
                break
            }
            a = this.yJ(a, c);
        ...
        Gb: function(a) {
            ...
            b = new J(a.lng, a.lat);
            for (var e = 0; e < this.fu.length; e++) if (b.lat >= this.fu[e]) {
                c = this.IF[e];
                break
            }
            if (!c) for (e = 0; e < this.fu.length; e++) if (b.lat <= -this.fu[e]) {
                c = this.IF[e];
                break
            }
            a = this.yJ(a, c);
    ...
    z.extend(S.prototype, {
        ...
        Sb: function(a, b, c, e, f) {
            if (a) return a = this.ci(a, f),
            b = this.fc(b),
            new R(Math.round((a.lng - c.lng) / b + e.width / 2), Math.round((c.lat - a.lat) / b + e.height / 2))
        },
        Ib: function(a, b, c, e, f) {
            if (a) return b = this.fc(b),
            this.gh(new J(c.lng + b * (a.x - e.width / 2), c.lat - b * (a.y - e.height / 2)), f)
        },
        fc: function(a) {
    ...
    z.extend(pc.prototype, {
        ...
        draw: function() {
            ...
            this.K.Da = new P( - Math.round(this.K.width / 2) - Math.round(this.K.nx), -Math.round(this.K.height / 2) - Math.round(this.K.nx));
    ...
    function sc(a, b, c, e) {
        a && (this.fv = {},
        this.gK = e ? !!e: t, this.Uc = [], this.n_ = a instanceof rc ? a: s, this.QH = b === l ? p: !!(b.indexOf("%") + 1), this.Oj = isNaN(parseFloat(b)) ? 1 : this.QH ? parseFloat(b) / 100 : parseFloat(b), this.RH = !!(c.indexOf("%") + 1), this.repeat = c != l ? this.RH ? parseFloat(c) / 100 : parseFloat(c) : 0)
    };
    function tc(a, b) {
        z.lang.Ga.call(this);
        this.content = a;
    ...
    z.extend(tc.prototype, {
        ...
        kN: function(a) { ! a && 0 != a || (isNaN(a) || 0 > a) || (0 != a && (220 > a && (a = 220), 730 < a && (a = 730)), this.K.maxWidth = a)
        },
        Dc: function(a) {
            this.K.title = a
        },
    ...
    function zc(a, b) {
        ...
        this.zA = [], this.ne = [], K.load("pointcollection",
        function() {
            for (var a = 0,
            b; b = c.zA[a]; a++) c[b.method].apply(c, b.arguments);
    ...
    z.extend(Fc.prototype, {
        ...
        Im: function(a, b) {
            this.Tn[a] && (this.Tn[a] = new J(b.lng, b.lat), this.na[a] = new J(b.lng, b.lat), 0 == a && !this.na[0].oc(this.na[this.na.length - 1]) && (this.na[this.na.length - 1] = new J(b.lng, b.lat)), this.uh())
        },
        Re: function() {
            var a = this.Tn;
    ...
    z.extend(Jc.prototype, {
        ...
        QK: function(a, b, c) {
            ...
            y.Eq = t,
            this.Ne.push(y);
            if (n = this.um) for (var C in n) delete n[C];
            else this.um = {};
        ...
        b_: function(a, b, c, e) {
            ...
            m && m.Jb ? (yb(m.Jb, b), e && (e = new R(a[0], a[1]), g = this.map.R.we ? this.map.R.we.style: "normal", e = c.getTilesUrl(e, a[2], g), m.loaded = t, Pc(m, e)), m.loaded ? this.wf() : Qc(m,
            function() {
                f.wf()
            })) : (m = this.Ti[i]) && m.Jb ? (c.Lb.insertBefore(m.Jb, c.Lb.lastChild), this.vg[i] = m, yb(m.Jb, b), e && (e = new R(a[0], a[1]), g = this.map.R.we ? this.map.R.we.style: "normal", e = c.getTilesUrl(e, a[2], g), m.loaded = t, Pc(m, e)), m.loaded ? this.wf() : Qc(m,
            function() {
                f.wf()
            })) : (m = k * Math.pow(2, g.Yh() - a[2]), new J(a[0] * m, a[1] * m), e = new R(a[0], a[1]), g = this.map.R.we ? this.map.R.we.style: "normal", e = c.getTilesUrl(e, a[2], g), m = new Rc(this, e, b, a, c), Qc(m,
            function() {
                f.wf()
            }), m.Cn(), this.vg[i] = m)
        },
        ...
        jD: function(a, b) {
            return this.map.va() === Sa ? "TILE-" + b.ea + "-" + this.map.cw + "-" + a[0] + "-" + a[1] + "-" + a[2] : "TILE-" + b.ea + "-" + a[0] + "-" + a[1] + "-" + a[2]
        },
        $w: function(a) {
            var b = a.Jb;
        ...
        wU: function(a, b) {
            for (var c = 256 * Math.pow(2, 18 - b), e = Math.floor(this.gA / c), f = Math.floor(this.hA / c), c = Math.floor(this.dA / c), g = [], i = 0; i < a.length; i++) {
                var k = a[i],
                m = k[0],
                k = k[1];
                if (m >= e) {
        ...
        xH: function(a) {
            ...
            for (var k = 0; k < c; k++) {
                ...
                if (!m.b1 && !(m.jx && !this.map.Od() || m.vL && this.map.Od())) {
                    ...
                    for (F in C) {
                        var E = C[F],
                        G = E.info; (G[2] != w || G[2] == w && (v > G[0] || y <= G[0] || o > G[1] || f <= G[1])) && this.$w(E)
                    }
                    ...
                    A = [];
                    for (e.cB = []; v < y; v++) for (B = o; B < f; B++) A.push([v, B]),
                    e.cB.push({
                        x: v,
                        y: B
                    });
        ...
        Vf: function(a) {
            ...
            if (a.jx) for (var b = 0,
            c = this.Bg.length; b < c; b++) a == this.Bg[b] && this.Bg.splice(b, 1);
            else {
                b = 0;
        ...
        ot: function(a) {
            var b = this.map.va();
            if (!this.map.Od() && (a ? this.map.R.k_ = a: a = this.map.R.k_, a)) for (var c = s,
            c = "2" == D.Rt ? [D.url.proto + D.url.domain.main_domain_cdn.other[0] + "/"] : [D.url.proto + D.url.domain.main_domain_cdn.baidu[0] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[1] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[2] + "/"], e = 0, f; f = this.nj[e]; e++) if (f.XZ == p) {
                b.m.pc = 18;
        ...
        this.Jb.onload = function() {
            ...
            if (i.rm) {
                ...
                if (i.Jb && !Ab(i.Jb) && f.Lb) {
                    ...
                    if (z.fa.ma <= 6 && z.fa.ma > 0 && i.BI) i.Jb.style.cssText = i.Jb.style.cssText + (';filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + i.src + '",sizingMethod=scale);')
                }
                var c = a.lE - a.tU,
                e;
                for (e in b) {
    ...
    Rc.prototype.Cn = function() {
        this.Jb.src = 0 < z.fa.ma && 6 >= z.fa.ma && this.BI ? H.sa + "blank.gif": "" !== this.src && this.Jb.src == this.src ? this.src + "&t = " + Date.now() : this.src
    };
    function Nc(a) {
    ...
    pb.prototype.getTilesUrl = function(a, b) {
        ...
        e = a.y,
        f = this.$a,
        c = Vc[Math.abs(c + e) % Vc.length] + "/image?grids=" + c + "_" + e + "_" + b + "&q=" + f.ht + "&tags=" + f.SE + "&filter=" + f.filter + "&sortby=" + f.uN + "&ak=" + this.$a.oB + "&age=" + f.YI + "&page_size=" + f.FM + "&format=" + f.v_;
        ...
        drawPoly: function(a, b, c, e, f, g) {
            ...
            if (i) for (var a = a[6], k = 0; k < i.length; k++) {
                ...
                if (n && n.length) for (var o = i[k][1], q = 0; q < o.length; q++) {
                    var v = o[q][1];
                    f.Nc(v[0], c) && (v["cache" + c] || (v["cache" + c] = f.xm(v[1], c, e, a)), v = v["cache" + c], f.M.Yn(b.canvas.id, v, {
                        type: "polygon",
                        Vb: m,
                        style: n
                    }), this.JV(b, v, n, c))
        ...
        drawGaoqingRoadBorder: function(a, b, c, e, f) {
            ...
            if (g) for (var a = a[6], i = 0; i < g.length; i++) {
                ...
                if (m && m.length && m[0].borderWidth) for (var n = g[i][1], o = 0; o < n.length; o++) {
                    var q = n[o][1];
                    f.Nc(q[0], c) && (q["cache" + c] || (q["cache" + c] = f.xm(q[1], c, e, a)), q = q["cache" + c], f.M.Yn(b.canvas.id, q, {
                        type: "polygon",
                        Vb: k,
                        style: m
                    }), this.LV(b, q, m))
    ...
    var gd = {
        parse: function(a, b, c, e, f) {
            for (var g = e.M,
            i = g.ka(), k = Math.pow(2, 18 - i), m = g.Pc.ci(g.Cb()), n = m.lng, o = m.lat, m = g.Hb(), q = m.width, v = m.height, m = [], w = 0; w < a.length; w++) {
                var y = [],
                A = a[w].t_;
                y.x = A[0];
                y.y = A[1];
                y.B5 = A[2];
                for (var B = (A[0] * c * k - n) / k + q / 2, C = (o - (A[1] + 1) * c * k) / k + v / 2, F = 0; F < a[w].length; F++) a[w][F].BL ? this.BM(a[w][F].BL, A, e, b, c, B, C, i, k, q, v, y) : a[w][F].DX ? this.BM(a[w][F].DX, A, e, b, c, B, C, i, k, q, v, y, p, window.u3) : this.NY(a[w][F].gY, A, e, b, c, B, C, i, k, q, v, y, f);
                m.push(y)
            }
            ...
            g.IU();
            for (w = 0; w < a.length; w++) if (c = a[w], !c.Js) if (F = [c.Rf, c.Sf, c.Rf, c.gi, c.fi, c.gi, c.fi, c.Sf, c.Rf, c.Sf], c.style && g.Yn("poi", F, {
                type: "polygon",
                Vb: c.style.Vb,
                style: c.style
            }), "fixed" === c.type) {
                ...
                if (c.style && !F) for (F = 0; F < c.sf.length; F++) this.UJ(b, c.sf[F].ae, c.sf[F].be, c.sf[F].text, c.style, e)
            } else if ("line" === c.type) for (F = 0; F < c.jO.length; F++) f = c.jO[F],
            gd.FV(b, f.ae, f.be, f.YT, f.hO, f.width, f.height, c.style, e);
            return m
        },
        ...
        Yr: function(a, b, c, e, f) {
            var g = b.ue;
            if ("lanche" !== g) if (gd.bx[g]) this.RJ(a, b, gd.bx[g], e, f);
            else {
                var c = c.zK(g),
                i = new Image;
        ...
        RJ: function(a, b, c, e, f) {
            ...
            if (b.style && 62203 === q) {
                for (var v = n = m = 0; v < b.sf.length; v++) m < b.sf[v].width && (m = b.sf[v].width),
                n += 20;
                m = Math.ceil(m) + 10
            }
            e && 519 === q && (o = t);
            m !== s && n !== s ? this.IV(a, b, c, 8, m, n) : e && o ? (m = Math.ceil(b.sf[0].width) + 6, this.BV(a, b, c, 12, m, c.height / 2)) : a.drawImage(c, i, k, g.width, g.height);
            f && f(b)
        },
        ...
        Hw: function(a, b) {
            var c = a.fontSize / 2,
            e = 10 * a.fontWeight;
            return e = b.DD ? e + " bold" + (" " + c + "px") + ' arial, "PingFang SC", sans-serif': e + (" " + c + "px") + " arial, sans-serif"
        },
        $Y: function(a, b) {
            var c = [],
            e = 0;
            ...
            g = a.length; f < g; f++) for (var i = a[f], k = 0, m = i.length; k < m; k++) {
                ...
                } else "line" === n.type ? (o = n.Rf, q = n.Sf, v = n.fi, w = n.gi) : "biaopai" === n.type && (w = n.q4, o = w.ae, q = w.be, v = w.ae + w.width, w = w.be + w.height);
            ...
            for (g = c.length; f < g; f++) {
                ...
                m.fi - e < i.Rf || (m.Rf > i.fi - e || m.gi - e < i.Sf || m.Sf > i.gi - e) || m.dJ.push(k)
            }
            f = 0;
            for (g = c.length; f < g; f++) if (k = c[f], k.Js === t) {
                e = k.dJ;
                k = 0;
    ...
    var md = {
        ...
        SN: function(a, b, c, e, f, g, i) {
            for (var k = 0; k < a.length; k++) {
                var m = a[k][0],
                n = g.hj(m, "line", b);
                if (n && n.length && (!i || n[0].borderWidth)) if (!n[0].zo || ld(n[0].zo, b)) for (var o = a[k][1], q = 0; q < o.length; q++) {
                    var v = o[q][3];
                    g.Nc(v[0], b) && (v["cache" + b] || (v["cache" + b] = g.xm(v[1], b, c, f)), v = v["cache" + b], g.M.Yn(e.canvas.id, v, {
                        type: "polyline",
                        Vb: m,
                        style: n
                    }), this.GV(e, v, n, i, b))
        ...
        GV: function(a, b, c, e, f) {
            ...
            if (!e && c.zo && ld(c.zo, f)) this.NV(a, b, c, ld(c.zo, f));
                ...
                c.borderWidth && e ? (a.strokeStyle = c.io, a.lineCap = hd[c.nU], a.lineJoin = id[1], a.lineWidth = c.borderWidth / 2, a.stroke()) : e || (a.strokeStyle = c.Cw, a.lineCap = hd[c.aW], a.lineJoin = id[1], a.lineWidth = c.fK / 2, a.stroke())
            }
        },
        NV: function(a, b, c, e) {
            if (c = e[1]) {
            ...
            if (e = e[0]) if (e.sd) this.EV(a, b, e);
            else {
    ...
    yd.prototype = {
        ...
        SJ: function(a, b, c, e, f, g, i) {
            var k = this;
            i || (i = 0); ! (z.om(window.rh) ? window.Np: window.Xt[g]) && 100 > i ? setTimeout(function() {
        ...
        hj: function(a, b, c, e) {
            var f = a + "-" + b + "-" + c;
            if (e) return td[f] || (td[f] = this.rg(a, b, c, e)),
            td[f];
    ...
    function Lc(a, b, c) {
        ...
        this.$a = {
            ...
            sD: c.iconUrls || ["https://ss0.bdstatic.com/8bo_dTSlR1gBo1vgoIiO_jowehsv/sty/map_icons2x/", "https://ss1.bdstatic.com/8bo_dTSlR1gBo1vgoIiO_jowehsv/sty/map_icons2x/"],
            JE: p
        };
        this.$A = "";
        this.XR = {};
        ...
        if (this.$a.JE) {
            ...
            function(a) {
                ...
                a: {
                    ...
                    var c = a.offsetY,
                    k = e.Jr.UY;
                    if (k) for (var m = 0; m < k.length; m++) for (var n = k[m], o = 0; o < n.length; o++) if (a = n[o], !a.Js && a.Es && b > a.Rf && b < a.fi && c > a.Sf && c < a.gi) {
                        b = a.Es;
                        b = {
                            type: 9,
                            name: a.name,
    ...
    fa.Wo = function(a) {
        ...
        w.Eq || (w.dB = s, delete w.dB, w.mn = t, this.Oe.push(w));
        o = [];
        v = f * this.Vc;
        b = 0;
        for (k = a.length; b < k; b++) {
            ...
            C.width = f + "px",
            C.height = f + "px",
            B.mn ? B.VE && B.VE && this.Jr.push(B.VE) : (B.zG = p, B.dB = s, delete B.dB, o.push([n, q, B]));
            else {
                if (0 < this.Oe.length) {
                    var B = this.Oe.shift(),
                    F = B.getContext("2d");
        ...
        if (0 === o.length) {
            ...
            e = this.Cd.ks(c);
            f = {};
            for (g = 0; g < this.sw.length; g++) i = this.sw[g],
            i = a + "_" + i[0] + "_" + i[1] + "_" + e + "_" + c,
            this.Xg[i] && (f[i] = this.Xg[i], this.fF && this.Fv.fC.eC(this.Xg[i].$_, this.Xg[i].s_, this.Xg[i].Sl, this.Xg[i].Dm, this.Xg[i].TD, this.Cd.Id(this.Xg[i].TD), this.Cd.aD(this.Xg[i].TD), this.$a.sD));
            this.Xg = f
        } else {
            this.Ps = o.length;
            this.hx = t;
                ...
                if (o !== t) {
                    ...
                    if (m.R.gk) {
                        ...
                        k.Fv.fC.eC(a, f, b, c, n, k.Cd.Id(n), k.Cd.aD(n), k.$a.sD), k.$a.JE) {
                            ...
                            f.VE = n;
                            k.Jr.push(n);
                            k.hx === t && k.Ps--; (0 === k.Ps || k.hx === p) && Ad(k)
                        }
                    } else k.Ps--,
                    (0 === k.Ps || k.hx === p) && Ad(k);
                    delete window[y]
    ...
    fa.Me = function(a) {
        if (a instanceof Lc) {
            for (var b = 0; b < this.af.length; b++) if (this.af[b] === a) return;
            this.af.push(a);
            a.xa();
    ...
    fa.Vf = function(a) {
        if (a instanceof Lc) {
            for (var b = 0; b < this.af.length; b++) if (this.af[b] === a) {
                this.af.splice(b, 1);
                break
            }
            a.remove()
    ...
    Id = new Mc;
    Id.DN = [D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[0] + "/resource/mappic/", D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[1] + "/resource/mappic/", D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[2] + "/resource/mappic/", D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[3] + "/resource/mappic/"];
    Id.getTilesUrl = function(a, b) {
        var c = a.x,
        e = a.y,
        f = 256 * Math.pow(2, 20 - b),
        e = Math.round((9998336 - f * e) / f) - 1;
        return url = this.DN[Math.abs(c + e) % this.DN.length] + this.map.Wb + "/" + this.map.cw + "/3/lv" + (21 - b) + "/" + c + "," + e + ".jpg"
    };
    var Sa = new Dd("\u4e09\u7ef4", Id, {
        tips: "\u663e\u793a\u4e09\u7ef4\u5730\u56fe",
        minZoom: 15,
    ...
    Sa.kk = function(a) {
        ...
        var b = H.yB,
        c;
        for (c in b) if ( - 1 < a.search(c)) return b[c].Gx;
        return ""
    };
    Sa.sK = function(a) {
        return {
    ...
    function X(a, b) {
        ...
        this.m.pa.Vg = "undefined" != typeof b && "undefined" != typeof b.renderOptions && "undefined" != typeof b.renderOptions.autoViewport ? b.renderOptions.autoViewport: p;
    ...
    z.extend(be.prototype, {
        ...
        bV: function() {
            ...
            if (this.page < this.Uf) e = 0 == this.page % this.Uf ? this.page - this.Uf - 1 : this.page - this.page % this.Uf + 1,
            b = e + this.Uf - 1;
            else {
    ...
    ge.PO = " \u73af\u5c9b \u65e0\u5c5e\u6027\u9053\u8def \u4e3b\u8def \u9ad8\u901f\u8fde\u63a5\u8def \u4ea4\u53c9\u70b9\u5185\u8def\u6bb5 \u8fde\u63a5\u9053\u8def \u505c\u8f66\u573a\u5185\u90e8\u9053\u8def \u670d\u52a1\u533a\u5185\u90e8\u9053\u8def \u6865 \u6b65\u884c\u8857 \u8f85\u8def \u531d\u9053 \u5168\u5c01\u95ed\u9053\u8def \u672a\u5b9a\u4e49\u4ea4\u901a\u533a\u57df POI\u8fde\u63a5\u8def \u96a7\u9053 \u6b65\u884c\u9053 \u516c\u4ea4\u4e13\u7528\u9053 \u63d0\u524d\u53f3\u8f6c\u9053".split(" ");
    z.wa(ge, de, "DWRoute");
    ...
    function Ra(a, b) {
        function c() {
            f.m.visible ? ("inter" === f.Ie && f.m.haveBreakId && f.m.indoorExitControl === p ? z.U.show(f.Lz) : z.U.aa(f.Lz), this.m.closeControl && this.xf && this.M && this.M.Ta() === this.P ? z.U.show(f.xf) : z.U.aa(f.xf), this.m.forceCloseControl && z.U.show(f.xf)) : (z.U.aa(f.xf), z.U.aa(f.Lz))
        }
        ...
        this.Og = [];
        this.Rq = [];
        "cvsRender" == this.Sj || Qa() ? (this.Kj = 90, this.Mj = -90) : "cssRender" == this.Sj && (this.Kj = 45, this.Mj = -45);
        this.Vq = t;
        var f = this;
        this.Cn = function() {
            this.Sj === "flashRender" ? K.load("panoramaflash",
            function() {
                f.Gi()
            },
            p) : K.load("panorama",
    ...
    z.extend(Ra.prototype, {
        ...
        Cc: function(a, b, c) {
            ...
            a != this.bb && (this.il = this.bb, this.jl = this.Mb, this.bb = a, this.Ie = b || "street", this.Mb = s, c && c.pov && this.qd(c.pov))
        },
        ua: function(a) {
            a.oc(this.Mb) || (this.il = this.bb, this.jl = this.Mb, this.Mb = a, this.bb = s)
        },
        qd: function(a) {
            a && (this.Ha = a, a = this.Ha.pitch, a > this.Kj ? a = this.Kj: a < this.Mj && (a = this.Mj), this.Vq = p, this.Ha.pitch = a)
        },
        SZ: function(a, b) {
            this.Mj = 0 <= a ? 0 : a;
            this.Kj = 0 >= b ? 0 : b
        ...
        Qc: function(a) {
            a != this.Kc && (a > ze && (a = ze), a < Ae && (a = Ae), a != this.Kc && (this.Kc = a), "cssRender" === this.Sj && this.qd(this.Ha))
        },
        NA: function() {
            if (this.M) for (var a = this.M.Pw(), b = 0; b < a.length; b++)(a[b] instanceof V || a[b] instanceof uc) && a[b].point && this.Ba.push(a[b])
        },
        DE: ca("M"),
        vt: function(a) {
            this.Jf = a || "none"
    ...
    z.extend(ec.prototype, {
        ga: function() {
            ...
            function() {
                c.Pg(ec.Tk + "qt=idata&iid=" + b.Hz + "&fn=",
                function(b) {
    ...
    z.extend(Oe, {
        ...
        EK: function(a, b, c, e, f) {
            ...
            return (Oe.gu + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g,
            function(a, b) {
                return g[b]
            })
        }
    ...
    sf = window.cancelRequestAnimationFrame || window.y5 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout,
    tf = gf ? " translateZ(0)": "";
    function uf(a, b) {
        var c = this,
        e;
        ...
        c.options.Mk ? c.Pb.style[Ze] = "translate(" + c.x + "px," + c.y + "px)" + tf: c.Pb.style.cssText += ";position:absolute;top:" + c.y + "px;left:" + c.x + "px";
        c.options.qi && (c.options.EC = p);
        c.refresh();
        c.ga(lf, window);
        c.ga(mf); ! hf && "none" != c.options.iO && (c.ga("DOMMouseScroll"), c.ga("mousewheel"));
        c.options.aw && (c.CU = setInterval(function() {
            c.BP()
        },
        500));
        this.options.Vw && (Event.prototype.stopImmediatePropagation || (document.body.removeEventListener = function(a, b, c) {
    ...
    uf.prototype = {
        ...
        BP: function() { ! this.hh && (!this.Pk && !(this.Ll || this.Rx == this.Pb.offsetWidth * this.scale && this.jp == this.Pb.offsetHeight * this.scale)) && this.refresh()
        },
        jv: function(a) {
            var b;
            this[a + "Scrollbar"] ? (this[a + "ScrollbarWrapper"] || (b = Pe.createElement("div"), this.options.tE ? b.className = this.options.tE + a.toUpperCase() : b.style.cssText = "position:absolute;z-index:100;" + ("h" == a ? "height:7px;bottom:1px;left:2px;right:" + (this.ri ? "7": "2") + "px": "width:7px;bottom:" + (this.$h ? "7": "2") + "px;top:2px;right:1px"), b.style.cssText += ";pointer-events:none;" + Xe + "transition-property:opacity;" + Xe + "transition-duration:" + (this.options.$V ? "350ms": "0") + ";overflow:hidden;opacity:" + (this.options.Zw ? "0": "1"), this.Sm.appendChild(b), this[a + "ScrollbarWrapper"] = b, b = Pe.createElement("div"), this.options.tE || (b.style.cssText = "position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);" + Xe + "background-clip:padding-box;" + Xe + "box-sizing:border-box;" + ("h" == a ? "height:100%": "width:100%") + ";" + Xe + "border-radius:3px;border-radius:3px"), b.style.cssText += ";pointer-events:none;" + Xe + "transition-property:" + Xe + "transform;" + Xe + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1);" + Xe + "transition-duration:0;" + Xe + "transform: translate(0,0)" + tf, this.options.qi && (b.style.cssText += ";" + Xe + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)"), this[a + "ScrollbarWrapper"].appendChild(b), this[a + "ScrollbarIndicator"] = b), "h" == a ? (this.YK = this.ZK.clientWidth, this.tX = Qe.max(Qe.round(this.YK * this.YK / this.Rx), 8), this.sX.style.width = this.tX + "px") : (this.aO = this.bO.clientHeight, this.V_ = Qe.max(Qe.round(this.aO * this.aO / this.jp), 8), this.U_.style.height = this.V_ + "px"), this.HA(a, p)) : this[a + "ScrollbarWrapper"] && (jf && (this[a + "ScrollbarIndicator"].style[Ze] = ""), this[a + "ScrollbarWrapper"].parentNode.removeChild(this[a + "ScrollbarWrapper"]), this[a + "ScrollbarWrapper"] = s, this[a + "ScrollbarIndicator"] = s)
        },
        GA: function() {
            var a = this;
            setTimeout(function() {
        ...
        Uq: function(a, b) {
            this.Pk || (a = this.Oo ? a: 0, b = this.Pm ? b: 0, this.options.Mk ? this.Pb.style[Ze] = "translate(" + a + "px," + b + "px) scale(" + this.scale + ")" + tf: (a = Qe.round(a), b = Qe.round(b), this.Pb.style.left = a + "px", this.Pb.style.top = b + "px"), this.x = a, this.y = b, this.HA("h"), this.HA("v"))
        },
        HA: function(a, b) {
            var c = "h" == a ? this.x: this.y;
            this[a + "Scrollbar"] && (c *= this[a + "ScrollbarProp"], 0 > c ? (this.options.EC || (c = this[a + "ScrollbarIndicatorSize"] + Qe.round(3 * c), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width": "height"] = c + "px"), c = 0) : c > this[a + "ScrollbarMaxScroll"] && (this.options.EC ? c = this[a + "ScrollbarMaxScroll"] : (c = this[a + "ScrollbarIndicatorSize"] - Qe.round(3 * (c - this[a + "ScrollbarMaxScroll"])), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width": "height"] = c + "px", c = this[a + "ScrollbarMaxScroll"] + (this[a + "ScrollbarIndicatorSize"] - c))), this[a + "ScrollbarWrapper"].style[df] = "0", this[a + "ScrollbarWrapper"].style.opacity = b && this.options.Zw ? "0": "1", this[a + "ScrollbarIndicator"].style[Ze] = "translate(" + ("h" == a ? c + "px,0)": "0," + c + "px)") + tf)
        },
        LP: function(a) {
            if (a.DQ === p) return this.fB = a.target,
            this.Bw = Date.now(),
            p;
            if (this.fB && this.Bw) {
                if (600 < Date.now() - this.Bw) return this.Bw = this.fB = s,
                p
            } else {
            ...
            if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.bZ = p,
            a.stopPropagation(),
            a.preventDefault(),
            this.Bw = this.fB = s,
            t
        ...
        sv: function(a) {
            ...
            e;
            if (this.enabled) {
                this.options.jM && this.options.jM.call(this, a); (this.options.qi || this.options.zoom) && this.AI(0);
                this.Pk = this.Ll = this.hh = t;
                this.VB = this.UB = this.Lv = this.Kv = this.aC = this.$B = 0;
                this.options.zoom && (hf && 1 < a.touches.length) && (e = Qe.abs(a.touches[0].pageX - a.touches[1].pageX), c = Qe.abs(a.touches[0].pageY - a.touches[1].pageY), this.C_ = Qe.sqrt(e * e + c * c), this.Ax = Qe.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.lF) / 2 - this.x, this.Bx = Qe.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.mF) / 2 - this.y, this.options.ap && this.options.ap.call(this, a));
                if (this.options.sx && (this.options.Mk ? (c = getComputedStyle(this.Pb, s)[Ze].replace(/[^0-9\-.,]/g, "").split(","), e = +(c[12] || c[4]), c = +(c[13] || c[5])) : (e = +getComputedStyle(this.Pb, s).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Pb, s).top.replace(/[^0-9-]/g, "")), e != this.x || c != this.y)) this.options.qi ? this.Zd(qf) : sf(this.qB),
                this.qj = [],
                this.Uq(e, c),
        ...
        fS: function(a) {
            ...
            this.B_ = Qe.sqrt(f * f + g * g),
            this.Pk = p,
            b = 1 / this.C_ * this.B_ * this.scale,
            b < this.options.Ok ? b = 0.5 * this.options.Ok * Math.pow(2, b / this.options.Ok) : b > this.options.Cp && (b = 2 * this.options.Cp * Math.pow(0.5, this.options.Cp / b)),
            this.Uo = b / this.scale,
            f = this.Ax - this.Ax * this.Uo + this.x,
            g = this.Bx - this.Bx * this.Uo + this.y,
            this.Pb.style[Ze] = "translate(" + f + "px," + g + "px) scale(" + b + ")" + tf,
            this.options.wM && this.options.wM.call(this, a);
            else {
                this.ih = b.pageX;
                this.jh = b.pageY;
                if (0 < f || f < this.ge) f = this.options.jo ? this.x + c / 2 : 0 <= f || 0 <= this.ge ? 0 : this.ge;
                if (g > this.nf || g < this.od) g = this.options.jo ? this.y + e / 2 : g >= this.nf || 0 <= this.od ? this.nf: this.od;
                this.$B += c;
                this.aC += e;
                this.Kv = Qe.abs(this.$B);
                this.Lv = Qe.abs(this.aC);
                6 > this.Kv && 6 > this.Lv || (this.options.RD && (this.Kv > this.Lv + 5 ? (g = this.y, e = 0) : this.Lv > this.Kv + 5 && (f = this.x, c = 0)), this.hh = p, this.Uq(f, g), this.UB = 0 < c ? -1 : 0 > c ? 1 : 0, this.VB = 0 < e ? -1 : 0 > e ? 1 : 0, 300 < i - this.startTime && (this.startTime = i, this.Ht = this.x, this.It = this.y), this.options.tM && this.options.tM.call(this, a))
            }
        },
        Du: function(a) {
            if (! (hf && 0 !== a.touches.length)) {
                ...
                if (b.Pk) e = b.scale * b.Uo,
                e = Math.max(b.options.Ok, e),
                e = Math.min(b.options.Cp, e),
                b.Uo = e / b.scale,
                b.scale = e,
                b.x = b.Ax - b.Ax * b.Uo + b.x,
                b.y = b.Bx - b.Bx * b.Uo + b.y,
                b.Pb.style[af] = "200ms",
                b.Pb.style[Ze] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + tf,
                b.Pk = t,
                b.refresh(),
                b.options.$o && b.options.$o.call(b, a);
                    ...
                    if (b.hh) {
                        ...
                        g.Fa || i.Fa ? (c = Qe.max(Qe.max(g.time, i.time), 10), b.options.Et && (g = e - b.Mv, i = f - b.Nv, Qe.abs(g) < b.options.by && Qe.abs(i) < b.options.by ? b.scrollTo(b.Mv, b.Nv, 200) : (g = b.qI(e, f), e = g.x, f = g.y, c = Qe.max(g.time, c))), b.scrollTo(Qe.round(e), Qe.round(f), c)) : b.options.Et ? (g = e - b.Mv, i = f - b.Nv, Qe.abs(g) < b.options.by && Qe.abs(i) < b.options.by ? b.scrollTo(b.Mv, b.Nv, 200) : (g = b.qI(b.x, b.y), (g.x != b.x || g.y != b.y) && b.scrollTo(g.x, g.y, g.time))) : b.Jn(200)
                    } else {
                        if (hf) if (b.LJ && b.options.zoom) clearTimeout(b.LJ),
                        b.LJ = s,
                        b.options.ap && b.options.ap.call(b, a),
                        b.zoom(b.ih, b.jh, 1 == b.scale ? b.options.wV: 1),
                        b.options.$o && setTimeout(function() {
                        ...
                        200);
                            ...
                            "select" != f && "input" != f && "textarea" != f ? (f = Pe.createEvent("MouseEvents"), f.initMouseEvent("click", p, p, a.view, 1, c.screenX, c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, 0, s), f.DQ = p, e.dispatchEvent(f)) : e.focus()
                        }
                        b.Jn(400)
                    }
        ...
        Jn: function(a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.hh && (this.hh = t, this.options.yx && this.options.yx.call(this)), this.$h && this.options.Zw && ("webkit" == Se && (this.ZK.style[df] = "300ms"), this.ZK.style.opacity = "0"), this.ri && this.options.Zw)"webkit" == Se && (this.bO.style[df] = "300ms"),
        ...
        JT: function(a) {
            ...
            if ("zoom" == b.options.iO) {
                if (e = b.scale * Math.pow(2, 1 / 3 * (e ? e / Math.abs(e) : 0)), e < b.options.Ok && (e = b.options.Ok), e > b.options.Cp && (e = b.options.Cp), e != b.scale) ! b.ly && b.options.ap && b.options.ap.call(b, a),
                b.ly++,
                b.zoom(a.pageX, a.pageY, e, 400),
                setTimeout(function() {
                    b.ly--; ! b.ly && b.options.$o && b.options.$o.call(b, a)
                },
                400)
            } else c = b.x + c,
            e = b.y + e,
            0 < c ? c = 0 : c < b.ge && (c = b.ge),
            e > b.nf ? e = b.nf: e < b.od && (e = b.od),
        ...
        TA: function() {
            ...
            g,
            i;
            a.Ll || (a.qj.length ? (f = a.qj.shift(), f.x == b && f.y == c && (f.time = 0), a.Ll = p, a.hh = p, a.options.qi) ? (a.AI(f.time), a.Uq(f.x, f.y), a.Ll = t, f.time ? a.ga(qf) : a.Jn(0)) : (i = function() {
                var k = Date.now(),
                m;
                if (k >= e + f.time) {
                    a.Uq(f.x, f.y);
        ...
        ga: function(a, b, c) { (b || this.Pb).addEventListener(a, this, !!c)
        },
        Zd: function(a, b, c) { (b || this.Pb).removeEventListener(a, this, !!c)
        },
        SB: ha(2),
        refresh: function() {
            var a, b, c, e = 0;
            ...
            if ("string" == typeof this.options.Et) {
                ...
                a = 0;
                for (b = c.length; a < b; a++) e = this.Oj(c[a]),
                e.left += this.lF,
                e.top += this.mF,
                this.Ue[a] = e.left < this.ge ? this.ge: e.left * this.scale,
                this.pf[a] = e.top < this.od ? this.od: e.top * this.scale
            } else if (this.options.Et) {
                for (this.Ue = []; e >= this.ge;) this.Ue[b] = e,
                e -= this.Vt,
                b++;
                this.ge % this.Vt && (this.Ue[this.Ue.length] = this.ge - this.Ue[this.Ue.length - 1] + this.Ue[this.Ue.length - 1]);
                b = e = 0;
                for (this.pf = []; e >= this.od;) this.pf[b] = e,
                e -= this.Tm,
                b++;
                this.od % this.Tm && (this.pf[this.pf.length] = this.od - this.pf[this.pf.length - 1] + this.pf[this.pf.length - 1])
            }
            this.jv("h");
            this.jv("v");
        ...
        scrollTo: function(a, b, c, e) {
            ...
            a = 0;
            for (b = f.length; a < b; a++) f[a].eZ && (f[a].x = this.x - f[a].x, f[a].y = this.y - f[a].y),
            this.qj.push({
                x: f[a].x,
                y: f[a].y,
                time: f[a].time || 0
        ...
        zoom: function(a, b, c, e) {
            var f = c / this.scale;
            this.options.Mk && (this.Pk = p, e = e === l ? 200 : e, a = a - this.lF - this.x, b = b - this.mF - this.y, this.x = a - a * f + this.x, this.y = b - b * f + this.y, this.scale = c, this.refresh(), this.x = 0 < this.x ? 0 : this.x < this.ge ? this.ge: this.x, this.y = this.y > this.nf ? this.nf: this.y < this.od ? this.od: this.y, this.Pb.style[af] = e + "ms", this.Pb.style[Ze] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + tf, this.Pk = t)
        }
    };
    function Ye(a) {
        if ("" === Se) return a;
    ...
    z.extend(vf.prototype, {
        ...
        Mx: function(a, b) {
            if (b || !this.Qj[this.Yc] || !(this.Qj[this.Yc].panoId == a && 3 !== this.Qj[this.Yc].recoType)) {
                var c = this,
                e = this.RG(a); ! b && -1 !== e && this.Qj[e] && 3 !== this.Qj[e].recoType ? this.mp(e) : this.YW(function(a) {
                    for (var b = {},
                    e, k, m = t,
            ...
            this.zP.innerHTML = a;
                ...
                function(a) {
                    if (a = (a.srcElement || a.target).getAttribute("dataindex")) {
                        c.wl(c.kG[a]);
                        for (var e = b.getElementsByTagName("li"), f = 0, g = e.length; f < g; f++) e[f].childNodes[0].getAttribute("dataindex") === a ? z.U.eb(e[f], "pano_catlogLiActive") : z.U.tc(e[f], "pano_catlogLiActive")
                    }
                });
                var a = O("div"),
                e = O("a"),
        ...
        wl: function(a) {
            this.Qj = a;
            this.m.showCatalog && (0 < this.Ei.length ? (Xa() ? this.$U() : this.cV(), this.Rc.offsetLeft = 60) : (this.cs && (this.P.removeChild(this.cs), this.cs = s, this.Rc.eg.style.left = "0px"), this.Bi && (this.P.removeChild(this.Bi), this.Bi = s), this.Rc.offsetLeft = 0));
            var b = this.EW(a);
            Xa() && (this.Ei && 0 < this.Ei.length && this.m.showExit && this.lz) && (this.Rc.offsetLeft += this.cg.width + 8, this.cs ? this.cs.innerHTML = this.lz: this.aV());
            this.Jh.innerHTML = b;
            this.Jh.style.width = (this.cg.width + 8) * a.length + 8 + "px";
            a = this.P.offsetWidth;
            b = this.Jh.offsetWidth;
            this.Rc.js && (b += this.Rc.js());
            b < a - 2 * this.Rc.ui - this.Rc.offsetLeft ? this.P.style.width = b + this.Rc.offsetLeft + "px": (this.P.style.width = isNaN(Number(this.m.maxWidth)) === p ? this.m.maxWidth: this.m.maxWidth + "px", b < this.P.offsetWidth - 2 * this.Rc.ui - this.Rc.offsetLeft && (this.P.style.width = b + this.Rc.offsetLeft + "px"));
            this.Rc.refresh();
        ...
        EW: function(a) {
            for (var b, c, e, f, g = [], i = this.cg.height, k = this.cg.width, m = 0; m < a.length; m++) b = a[m],
            recoType = b.recoType,
            e = b.panoId,
            f = b.name,
            c = b.heading,
            b = b.pitch,
            c = Oe.EK(e, c, b, 198, 108),
        ...
        hP: function() {
            ...
            z.V(this.Vj, "click",
            function(b) {
                if ((b = (b.srcElement || b.target).getAttribute("data-index")) && b != a.Yc) a.mp(b),
                a.W.Cc(a.Qj[b].panoId)
            });
            z.V(this.Jh, "mouseover",
            function(b) {
    ...
    zf.prototype = {
        ...
        refresh: function() {
            ...
            this.eg && (this.eg.children[0].style.marginTop = this.br.children[0].style.marginTop = this.eg.offsetHeight / 2 - this.eg.children[0].offsetHeight / 2 + "px")
        },
        js: function() {
            return 2 * this.ui
        },
        Gr: function() {
            this.kv = O("div");
            this.kv.innerHTML = '<a class="pano_photo_arrow_l" style="background:rgb(37,37,37);background:rgba(37,37,37,0.9);" href="javascript:void(0)" title="\u4e0a\u4e00\u9875"><span class="pano_arrow_l"></span></a><a class="pano_photo_arrow_r" style="background:rgb(37,37,37);background:rgba(37,37,37,0.9);" href="javascript:void(0)" title="\u4e0b\u4e00\u9875"><span class="pano_arrow_r"></span></a>';
            this.eg = this.kv.children[0];
            this.br = this.kv.children[1];
            this.P.appendChild(this.kv);
            this.eg.children[0].style.marginTop = this.br.children[0].style.marginTop = this.eg.offsetHeight / 2 - this.eg.children[0].offsetHeight / 2 + "px"
        },
        sB: function() {
            var a = this;
            z.V(this.eg, "click",
        ...
        scrollTo: function(a) {
            a = a < this.Rg.offsetLeft ? Math.ceil((a - this.ui - this.Fn) / this.kr) * this.kr + this.Fn + this.ui - 8 : Math.ceil((a - this.ui) / this.kr) * this.kr + this.ui;
