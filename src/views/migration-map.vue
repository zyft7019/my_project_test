<template>
  <div id="migration-map" :style="{width: '800px', height: '800px'}">migration</div>
</template>
...
export default {
  ...
  methods: {
    initMigration() {
      let myMigration = this.$echarts.init(
        document.getElementById("migration-map")
      );
      const curveness  = 0.2
      var options = {
        title: {
